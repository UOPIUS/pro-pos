...
class SaleController extends Controller
{
            ...
            foreach ($data['paid_by_id'] as $key => $value) {
                if ($data['paid_amount'][$key] > 0) {
                    ...
                    elseif ($data['paid_by_id'][$key] == 2) {
                        ...
                        $paying_method = 'Transfer'; // Previously Credit Card
                    elseif ($data['paid_by_id'][$key] == 4)
                        $paying_method = 'POS'; // Previously Cheque
                    ...
                    if ($paying_method == 'Transfer') { //Previously Credit Card
                        $cardDetails = [];
                        ...
                        $data['charge_id'] = Str::random(16); //previously 12345
    ...
    public function getPayment($id)
    {
        ...
        foreach ($lims_payment_list as $payment) {
            ...
            } elseif ($payment->paying_method == 'POS') {
    ...
    public function updatePayment(Request $request)
    {
        ...
        elseif ($data['edit_paid_by_id'] == 2) {
            ...
            if ($lims_pos_setting_data->stripe_secret_key) {
                Stripe::setApiKey($lims_pos_setting_data->stripe_secret_key);
                if ($lims_payment_data->paying_method == 'Transfer') {
            ...
            if ($lims_payment_data->paying_method == 'POS') {
                ...
                $lims_payment_data->paying_method = 'POS';
    ...
    public function deletePayment(Request $request)
    {
        ...
        } elseif ($lims_payment_data->paying_method == 'Transfer') {
            $lims_pos_setting_data = PosSetting::latest()->first();
            if ($lims_pos_setting_data->stripe_secret_key) {
        ...
        } elseif ($lims_payment_data->paying_method == 'POS') {
        ...
        foreach ($sale_id as $id) {
            ...
            foreach ($lims_payment_data as $payment) {
                if ($payment->paying_method == 'Gift Card') {
                    ...
                    $lims_payment_cheque_data = PaymentWithCheque::where('payment_id', $payment->id)->first();
                    $lims_payment_cheque_data->delete();
                } elseif ($payment->paying_method == 'Transfer') {
